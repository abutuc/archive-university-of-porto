...
const TextArea: React.FC<TextareaProps> = ({
  ...
  if (disabled) {
    ...
    textareaClasses += ` bg-transparent border-red-500 focus:border-red-500 focus:ring-3 focus:ring-red-500/30 dark:border-red-600 dark:bg-gray-900 dark:text-white/90 dark:focus:border-red-800`;
  } else {
