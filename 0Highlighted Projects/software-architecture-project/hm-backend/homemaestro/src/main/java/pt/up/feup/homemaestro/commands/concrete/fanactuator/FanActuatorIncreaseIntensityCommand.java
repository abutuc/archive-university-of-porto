...
public class FanActuatorIncreaseIntensityCommand implements Command {
    private FanActuator fanActuator;

    public FanActuatorIncreaseIntensityCommand(FanActuator fanActuator) {
