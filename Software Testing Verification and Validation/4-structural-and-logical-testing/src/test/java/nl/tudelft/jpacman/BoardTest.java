...
public class BoardTest {
    ...
    @Test
    public void testBoardWithNullSquares() {
        Square[][] grid = new Square[1][1];
        grid[0][0] = null;
        assertThrows(AssertionError.class, () ->  new BoardFactory(null).createBoard(grid));
    }
    ...
    public void testGetSquareAt() {
        ...
        Square square1 = boardFactory.createWall();
        Square[][] grid = new Square[1][2];
        grid[0][0] = square;
        grid[0][1] = square1;
        Board board = boardFactory.createBoard(grid);

        assertEquals(square1.getSquareAt(Direction.SOUTH), square);
